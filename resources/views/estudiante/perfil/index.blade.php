                ...
                <div x-show="activeTab === 'info'" x-transition class="space-y-6">
                    ...
                    <div class="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-xl p-8 text-white shadow-xl">
                        <div class="flex items-center gap-6">
                            ...
                            <div class="flex-1">
                                <h2 class="text-3xl font-bold mb-2">{{ $estudiante->nombre }} {{ $estudiante->apellido }}</h2>
                                <div class="flex items-center gap-2 text-blue-100 mb-1">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                    </svg>
                                    <span class="text-lg">{{ $estudiante->correo }}</span>
                                </div>
                    ...
                    <div class="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-100">
                                ...
                                <p class="text-lg font-semibold text-gray-800">{{ $estudiante->telefono ?? 'No registrado' }}</p>
                            </div>
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <form action="{{ route('estudiante.perfil.correo') }}" method="POST" class="space-y-4">
                            @csrf
                            @method('PUT')
