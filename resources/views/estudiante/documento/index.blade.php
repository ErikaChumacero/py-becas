        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-xl shadow-lg p-8 text-white">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold">Mis Documentos</h1>
                        <p class="text-blue-100 mt-1">Gestiona los documentos de tus postulaciones</p>
                    </div>
                </div>
                <a href="{{ route('estudiante.documento.create') }}" 
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($rows as $d)
                            <tr class="hover:bg-blue-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900">{{ $d->convocatoria }}</div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ $d->rutaarchivo }}" target="_blank" 
                                       class="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800 font-medium transition-colors group">
                                        ...
                                        <span class="truncate max-w-[200px]">Ver PDF</span>
                                    </a>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($d->validado === '1')
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('estudiante.documento.edit', $d->iddocumento) }}" 
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <h3 class="text-sm font-semibold text-gray-900 mb-1">No hay documentos</h3>
                                        <p class="text-sm text-gray-500">Comienza subiendo tu primer documento</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
