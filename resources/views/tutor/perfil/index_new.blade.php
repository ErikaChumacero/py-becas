<x-tutor-layout>
    <div class="max-w-5xl mx-auto space-y-6" x-data="{ activeTab: 'info' }">
        <!-- Header -->
        <div class="bg-gradient-to-r from-green-600 to-emerald-700 rounded-lg shadow-lg p-8 text-white">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold">Mi Perfil de Tutor</h1>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div x-show="activeTab === 'info'" x-transition class="space-y-6">
                    ...
                    <div class="bg-gradient-to-br from-emerald-600 to-teal-700 rounded-xl p-8 text-white shadow-xl">
                        <div class="flex items-center gap-6">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-2">
                                    <h2 class="text-3xl font-bold">{{ $tutor->nombre }} {{ $tutor->apellido }}</h2>
                                    <span class="bg-blue-400 text-blue-900 text-xs font-bold px-3 py-1 rounded-full">TUTOR</span>
                                </div>
                                <div class="flex items-center gap-2 text-emerald-100 mb-1">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                    </svg>
                                    <span class="text-lg">{{ $tutor->correo }}</span>
                                </div>
                                <div class="flex items-center gap-2 text-emerald-100">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2"></path>
                                    </svg>
                                    <span>CI: {{ $tutor->ci }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4 border border-green-100">
                                ...
                                <p class="text-lg font-semibold text-gray-800">{{ $tutor->telefono ?? 'No registrado' }}</p>
                            </div>
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <form action="{{ route('tutor.perfil.correo') }}" method="POST" class="space-y-4">
                            @csrf
                            @method('PUT')
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" name="correo" value="{{ old('correo', $tutor->correo) }}" 
                                           class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors @error('correo') border-red-500 @enderror"
                ...
                <div x-show="activeTab === 'security'" x-transition x-data="{ showCurrent: false, showNew: false, showConfirm: false }">
                    <div class="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <form action="{{ route('tutor.perfil.password') }}" method="POST" class="space-y-4">
                            @csrf
                            @method('PUT')
