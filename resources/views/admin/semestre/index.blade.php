            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-blue-100 mt-1">Administra los períodos académicos</p>
                    </div>
                </div>
                <a href="{{ route('admin.semestre.create') }}" 
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($rows as $s)
                            <tr class="hover:bg-blue-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-700">{{ $s->descripcion }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('admin.semestre.edit', $s->idsemestre) }}" 
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-sm text-gray-500">No hay semestres registrados en el sistema</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
