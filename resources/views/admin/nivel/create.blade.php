<x-admin-layout>
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Nuevo Nivel</h1>
                <p class="text-gray-600 mt-1">Registra un nuevo nivel educativo</p>
            </div>
        </div>

        <!-- Formulario -->
        <div class="bg-white rounded-lg shadow-md p-8">
            <form action="{{ route('admin.nivel.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="bg-green-50 border-l-4 border-green-500 p-4 rounded-r-lg">
                    <div class="flex items-start">
                        ...
                        <div>
                            <h3 class="text-sm font-semibold text-green-800 mb-1">Ejemplos de niveles</h3>
                            <ul class="text-sm text-green-700 space-y-1">
                                <li>• <strong>Inicial</strong> - Para niños de 3 a 5 años</li>
                                <li>• <strong>Primaria</strong> - De 1ro a 6to grado</li>
                                <li>• <strong>Secundaria</strong> - De 1ro a 5to de secundaria</li>
                            </ul>
                        </div>
                    </div>
                </div>
