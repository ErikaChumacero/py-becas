            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-blue-100 mt-1">Auditoría de cambios en las postulaciones</p>
                    </div>
                </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($rows as $h)
                            ...
                            <tr class="hover:bg-blue-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900">{{ $h->estudiante }}</div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-700">{{ $h->convocatoria }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center gap-2">
                                        <a href="{{ route('admin.historial.edit', $h->idhistorialestado) }}" 
                                        ...
                                        <form action="{{ route('admin.historial.disable', $h->idhistorialestado) }}" method="POST" class="inline">
                                            @csrf
                                            <button onclick="return confirm('¿Deshabilitar este historial (estado nuevo a 0)?');" 
