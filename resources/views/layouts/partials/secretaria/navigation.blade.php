        ...
        <div class="flex items-center justify-between h-full">
            ...
            <div class="flex items-center gap-3">
                ...
                <button id="sidebar-toggle-header" type="button" 
                    class="flex items-center justify-center w-10 h-10 text-gray-600 hover:text-green-600 hover:bg-green-50 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500/20">
                ...
                <!-- Brand -->
                <a href="{{ route('secretaria.dashboard') }}" class="flex items-center gap-2 group">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                            <div class="p-3 border-b border-gray-100">
                                ...
                                <div class="py-2">
                                    <a href="{{ route('secretaria.perfil.index') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                                        <i class="fas fa-user-circle w-4"></i>
                                        <span>Mi Perfil</span>
                                    </a>
                                    <a href="{{ route('secretaria.dashboard') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
