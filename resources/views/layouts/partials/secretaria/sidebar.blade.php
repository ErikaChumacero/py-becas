@php
    // Módulos disponibles para Secretaría
    $modules = [
        [ 'name' => 'Gestionar Personas', 'icon' => 'fa-solid fa-users', 'route' => 'secretaria.persona.index', 'active' => request()->routeIs('secretaria.persona.*') ],
        [ 'name' => 'Gestionar Inscripciones', 'icon' => 'fa-solid fa-file-signature', 'route' => 'secretaria.inscripcion.index', 'active' => request()->routeIs('secretaria.inscripcion.*') ],
        [ 'name' => 'Gestionar Mensualidades', 'icon' => 'fa-solid fa-money-bill', 'route' => 'secretaria.mensualidad.index', 'active' => request()->routeIs('secretaria.mensualidad.*') ],
        [ 'name' => 'Gestionar Becas', 'icon' => 'fa-solid fa-graduation-cap', 'route' => 'secretaria.beca.index', 'active' => request()->routeIs('secretaria.beca.*') ],
        // TODO: Agregar más módulos según se desarrollen
        // [ 'name' => 'Gestionar Gestiones', 'icon' => 'fa-solid fa-calendar-days', 'route' => 'secretaria.gestion.index', 'active' => request()->routeIs('secretaria.gestion.*') ],
    ];
@endphp
...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-4 pb-4 overflow-y-auto sidebar-scroll">
        ...
        @if($u)
            <a href="{{ route('secretaria.perfil.index') }}" class="user-profile block cursor-pointer group">
        ...
        <nav>
            <ul class="space-y-1">
                <!-- Dashboard -->
                <li>
                    <a href="{{ route('secretaria.dashboard') }}" class="sidebar-item {{ request()->routeIs('secretaria.dashboard') ? 'active' : '' }}">
                ...
                <!-- Módulos adicionales (se agregarán después) -->
